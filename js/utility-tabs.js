...
// Halaman ini gabungan "Checklist PM Utility" (semua role) + "Rekap
// Checklist PM Utility" (khusus SPV/superadmin).
const tabInput = document.querySelector('.draft-tab[data-tab="input"]');
const tabRekap = document.getElementById("utility-tab-rekap");
