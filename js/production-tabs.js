...
// Halaman ini gabungan "Checklist PM Production" (semua role) + "Rekap
// Checklist PM Production" (khusus SPV/superadmin).
const tabInput = document.querySelector('.draft-tab[data-tab="input"]');
const tabRekap = document.getElementById("production-tab-rekap");
